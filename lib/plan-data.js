...
const FEATURE_TOOLTIPS = {
  ...
  google_business_profile: "Coming soon. Publicación en GBP en preparación.",
  blog_writer:     "Función en preparación. Por ahora está bloqueada.",
};
...
const LIMIT_TOOLTIPS = {
  ...
  maxBlogs:           "Coming soon. Por ahora no está disponible.",
};
...
const PLANS = [
  ...
  },
  {
    ...
    maxBlogs: 2,
    keywordsRange: "2",
    features: ["excel_report", "architecture", "keywords", "blog_writer"],
  },
  {
    key: "STARTER",
    label: "Starter",
    ...
    maxBlogs: 15,
    keywordsRange: "4",
    features: ["excel_report", "architecture", "performance", "page_speed", "keywords", "google_business_profile", "blog_writer", "extra_user"],
  },
  {
    key: "PRO",
    label: "Pro",
    ...
    maxBlogs: 30,
    keywordsRange: "10",
    features: ["excel_report", "architecture", "performance", "page_speed", "js_crawl", "keywords", "google_business_profile", "blog_writer", "extra_user"],
    highlighted: true,
  },
  {
    key: "AGENCY",
    ...
    maxBlogs: 100,
    keywordsRange: "20",
    features: ["excel_report", "architecture", "performance", "page_speed", "js_crawl", "keywords", "google_business_profile", "blog_writer", "multi_user"],
  },
];
...
const PLAN_DEFAULTS = Object.fromEntries(
  PLANS.map(({ key, maxProjects, maxPagesPerCrawl, maxCrawlsPerMonth, maxHistoryRuns, maxExtraUsers, maxKeywords, maxBlogs, keywordsRange, features }) => [
    key,
    { maxProjects, maxPagesPerCrawl, maxCrawlsPerMonth, maxHistoryRuns, maxExtraUsers, maxKeywords, maxBlogs, keywordsRange, features },
  ])
);

// Map: plan key → max keywords per page
const PLAN_KEYWORD_MAX = Object.fromEntries(PLANS.map((p) => [p.key, p.maxKeywords]));
const PLAN_BLOG_MAX = Object.fromEntries(PLANS.map((p) => [p.key, p.maxBlogs]));
