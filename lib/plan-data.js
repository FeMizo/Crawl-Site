const FEATURE_LABELS = {
  ...
  blog_writer:     "Generador de blogs SEO",
};
...
const FEATURE_TOOLTIPS = {
  ...
  blog_writer:     "Crea borradores SEO desde keywords y exporta a DOCX, WordPress o Google Drive.",
};
...
const LIMIT_TOOLTIPS = {
  ...
  maxBlogs:           "Cantidad de borradores de blog que puedes mantener por workspace.",
};
...
const PLANS = [
  ...
  },
  {
    ...
    maxBlogs: 15,
    keywordsRange: "4",
    features: ["excel_report", "architecture", "performance", "page_speed", "keywords", "blog_writer", "extra_user"],
  },
  {
    key: "PRO",
    label: "Pro",
    ...
    maxBlogs: 30,
    keywordsRange: "10",
    features: ["excel_report", "architecture", "performance", "page_speed", "js_crawl", "keywords", "blog_writer", "extra_user"],
    highlighted: true,
  },
  {
    key: "AGENCY",
    ...
    maxBlogs: 100,
    keywordsRange: "20",
    features: ["excel_report", "architecture", "performance", "page_speed", "js_crawl", "keywords", "blog_writer", "multi_user"],
  },
];
