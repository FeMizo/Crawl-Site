export default function Logo({ compact = false, className = "" }) {
  return (
    <svg
      ...
      fill="none"
    >
      <text x="0" y="22" fill="currentColor" fontFamily="Syne, Manrope, sans-serif" fontWeight="700" fontSize="17" letterSpacing="-0.02em">SEO</text>
      <circle cx="64" cy="20" r="2.2" fill="currentColor" opacity=".55"></circle>
      <text x="68" y="22" fill="currentColor" fontFamily="Syne, Manrope, sans-serif" fontWeight="700" fontSize="17" letterSpacing="-0.02em">CRAWLER</text>
